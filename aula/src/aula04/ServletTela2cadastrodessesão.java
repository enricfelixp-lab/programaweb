...
/**
 * Servlet implementation class ServletTela2cadastrodessesão
 */
@WebServlet("/ServletTela2cadastrodessesão")
public class ServletTela2cadastrodessesão extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServletRequest sessão;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletTela2cadastrodessesão() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         if (sessao == null 
            || sessao.getAttribute(ServletLogin.USUARIO) == null) {
                 ...
                 sessão = null;
				DadosPessoais dados = (DadosPessoais)sessão.getAttribute("dadosPessoais");
                 if (dados == null) {
                 resposta.write(
