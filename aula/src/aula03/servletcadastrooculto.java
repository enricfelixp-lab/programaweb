...
/**
 * Servlet implementation class servletcadastrooculto
 */
@WebServlet("/servletcadastrooculto")
public class servletcadastrooculto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public servletcadastrooculto() {
        super();
